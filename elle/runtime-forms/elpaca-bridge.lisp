## Emitted low-level Elpaca bridge forms.

(defn emacs-hypervisor-runtime-forms-elpaca-bridge-module []
  (defn runtime-forms []
    '((defvar elpaca-installer-version 0.12)
      ...
      (defun emacs-hypervisor-elpaca-shared-source-dir (orig-fn id dir)
        ...
        (let* ((queued (elpaca--queued))
               (index (cl-position id queued :key (function car) :test (function eq)))
      ...
      (defun emacs-hypervisor-elpaca-wait-for-main-file (e main attempts)
        ...
        (let ((file (expand-file-name main (elpaca<-source-dir e))))
          (cond
           ...
           (t
            (run-at-time 0.1 nil (function emacs-hypervisor-elpaca-wait-for-main-file)
                         e main (- attempts 1))))))

mod embedded {
    ...
    pub const EMBEDDED_SEXP_RPC_ELISP: &str =
        include_str!("../templates/lisp/emacs-hypervisor-sexp-rpc.el");
    pub const EMBEDDED_SESSION_STATE_ELISP: &str =
        include_str!("../templates/lisp/emacs-hypervisor-session-state.el");
}
...
const GENERATED_INIT_ELISP: &str = include_str!("../templates/init.el");
